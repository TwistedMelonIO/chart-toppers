...
app.get("/api/selftest/checklist", (req, res) => {
  const baseChecklist = [
      // Pre-show
      { id: 1,  round: "Pre-show", item: "Pre show loop" },
      { id: 2,  round: "Pre-show", item: "Opening" },

      // Opening
      { id: 3,  round: "Opening",  item: "Host walk on" },
      { id: 4,  round: "Opening",  item: "Team reveals (Icons / Anthems)" },
      { id: 5,  round: "Opening",  item: "Golden Record example" },

      // Round 1
      { id: 6,  round: "R1",       item: "Round 1 intro" },
      { id: 7,  round: "R1",       item: "Audience walk on" },
      { id: 8,  round: "R1",       item: "Coin flip (Icons / Anthems)" },
      { id: 9,  round: "R1",       item: "Genre picker (Pack 1–3 rounds)" },
      { id: 10, round: "R1",       item: "Audio tracks (6 tested)" },
      { id: 11, round: "R1",       item: "Buzzers (Win / Lose / Golden Record)" },
      { id: 12, round: "R1",       item: "Scoreboard" },
      { id: 13, round: "R1",       item: "Earned time — +4s per correct, max 24s (6 clips × 4s) — clock counts and displays correctly" },
      { id: 14, round: "R1",       item: "Both teams played → R1 auto-advances to R2" },
      { id: 15, round: "R1",       item: "Undo / wrong answer behaves correctly (earned time decreases, no false advance)" },
      { id: 16, round: "R1",       item: "QLab cue notes show correct answers in uppercase on .2 slots, .1 slots empty" },
      { id: 17, round: "R1",       item: "Golden Record can fire mid-round (not just example)" },
      { id: 18, round: "R1",       item: "Golden Buzzer refresh (check)" },
      { id: 19, round: "R1",       item: "Golden Buzzer correct answer doubles points for both teams (Anthems + Icons)" },

      // Round 2
      { id: 20, round: "R2",       item: "Round 2 intro" },
      { id: 21, round: "R2",       item: "Background" },
      { id: 22, round: "R2",       item: "Audience sting" },
      { id: 23, round: "R2",       item: "Coin flip (Icons / Anthems)" },
      { id: 24, round: "R2",       item: "Genre picker (all genres across packs 1–3)" },
      { id: 25, round: "R2",       item: "Audio tracks updating" },
      { id: 26, round: "R2",       item: "Refresh tracks (second team)" },
      { id: 27, round: "R2",       item: "Audience walk off" },
      { id: 28, round: "R2",       item: "Scoreboard" },
      { id: 29, round: "R2",       item: "Leader-first logic — no draw, leading team plays first (no coin flip)" },
      { id: 30, round: "R2",       item: "Buzzers fully disarmed for entire round (IBUZZ/ABUZZ locked out)" },
      { id: 31, round: "R2",       item: "/playing/ OSC navigates StreamDeck to active team’s page" },
      { id: 32, round: "R2",       item: "Both teams played → R2 auto-advances to R3" },
      { id: 33, round: "R2",       item: "Earned time — +6s per correct, max 12s (2 tracks × 6s) — accrues correctly" },
      { id: 34, round: "R2",       item: "Golden Buzzer refresh (check)" },
      { id: 35, round: "R2",       item: "Golden Buzzer correct answer doubles points for both teams (Anthems + Icons)" },

      // Round 3
      { id: 36, round: "R3",       item: "Round 3 intro" },
      { id: 37, round: "R3",       item: "Background" },
      { id: 38, round: "R3",       item: "Audience walk-up sting" },
      { id: 39, round: "R3",       item: "Coin flip" },
      { id: 40, round: "R3",       item: "Genre picker (packs 1–3)" },
      { id: 41, round: "R3",       item: "Track selection & Companion red button" },
      { id: 42, round: "R3",       item: "Buzzer pause / correct stops / incorrect continues / buzzer lock-out" },
      { id: 43, round: "R3",       item: "Scoreboard" },
      { id: 44, round: "R3",       item: "Leader-first (no draw) — leading team plays first without coin flip; StreamDeck on correct page" },
      { id: 45, round: "R3",       item: "Mashup tracks — R3-specific mashups load and play correctly" },
      { id: 46, round: "R3",       item: "Post-correct navigation — returns to 4-choice page and stops active mashup" },
      { id: 47, round: "R3",       item: "Re-arm after wrong — both buzzers re-arm correctly between tracks" },
      { id: 48, round: "R3",       item: "R3SCORES cue notes — populated correctly in QLab" },
      { id: 49, round: "R3",       item: "Earned time — +8s per correct, max 64s — accrues correctly" },
      { id: 50, round: "R3",       item: "Golden Buzzer refresh (check)" },
      { id: 51, round: "R3",       item: "Golden Buzzer correct answer doubles points for both teams (Anthems + Icons)" },

      // Round 4
      { id: 52, round: "R4",       item: "Round 4 intro" },
      { id: 53, round: "R4",       item: "Background" },
      { id: 54, round: "R4",       item: "Audience walk up" },
      { id: 55, round: "R4",       item: "Coin flip (Icons / Anthems)" },
      { id: 56, round: "R4",       item: "Lowest scoring team first" },
      { id: 57, round: "R4",       item: "Tracks working correctly" },
      { id: 58, round: "R4",       item: "Companion buttons — correct = next track, incorrect = delay, skip = delay" },
      { id: 59, round: "R4",       item: "Single scoreboard after first team" },
      { id: 60, round: "R4",       item: "Second team starts (buttons as above)" },
      { id: 61, round: "R4",       item: "Dual scoreboard" },
      { id: 62, round: "R4",       item: "Tiebreaker if draw (auto target)" },
      { id: 63, round: "R4",       item: "Jump to R5 if clear winner" },
      { id: 64, round: "R4",       item: "Countdown videos load with correct remaining time — total earned time from R1–R3 (sum of +4/+6/+8 per correct) carries over and seeks correctly. R4 itself = +1 point per correct (no time added)." },
      { id: 65, round: "R4",       item: "Panic-all + re-enter R4 → load-to-time re-sent correctly (no full restart)" },
      { id: 66, round: "R4",       item: "R4TF cue notes in QLab show correct answers in uppercase" },
      { id: 67, round: "R4",       item: "Earned-time handover — second team’s countdown starts at their accumulated time" },
      { id: 68, round: "R4",       item: "Buzzers stay disarmed during normal R4 play; armed only during tiebreaker" },
      { id: 69, round: "R4",       item: "Audio bed / VT sting fires when a team’s countdown ends" },

      // Round 5
      { id: 70, round: "R5",       item: "Winner" },
      { id: 71, round: "R5",       item: "Host walk off" },
      { id: 72, round: "R5",       item: "Closing VT" },
      { id: 73, round: "R5",       item: "End show" },
      { id: 74, round: "R5",       item: "Show reset — full game reset at end clears all state and goto cues (ready for next show)" },

      // UI / general
      { id: 75, round: "UI",       item: "Genre picker — font sizes render correctly across all packs (no overflow / clipping when pack changes)" },
  ];
